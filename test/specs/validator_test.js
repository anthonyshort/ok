...
describe('OK.Validator', function() {
  ...
  it('should validate an email', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      email = _ref1[_j];
      _results.push(expect(this.validator.email(email)).to.be["false"]);
    }
    return _results;
  });
  it('should validate a url', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.url(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate alphanumeric', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.alphanumeric(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate hex', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.hex(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate strings', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.string(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate numbers', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.number(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate arrays', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.array(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate dates', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.date(value)).to.be["false"]);
    }
    return _results;
  });
  it('should validate booleans', function() {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      value = _ref1[_j];
      _results.push(expect(this.validator.boolean(value)).to.be["false"]);
    }
    return _results;
  });
