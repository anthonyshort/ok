...
describe('OK.Validator', function() {
  ...
  it('should validate an email', function() {
    var email, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results;
    ...
    _ref2 = ['@bar.com', 'foo@bar', 'foo', null, false, void 0];
    _results = [];
  ...
  it('should validate a url', function() {
    var url, value, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results;
    ...
    _ref2 = ['google', 'htp://google.com', null, false, 'foo@bar.co.uk', 'google .com'];
    _results = [];
    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      value = _ref2[_k];
  ...
  it('should validate alphanumeric', function() {
    ...
    _ref2 = ["Anthony's bike", '-', '&!$@#*', 'a b c', false, null, void 0];
    _results = [];
    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      value = _ref2[_k];
  ...
  it('should validate hex', function() {
    ...
    _ref2 = ['#GGG', 'abc', 'fff', '#0000000', false, null, void 0];
    _results = [];
    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      value = _ref2[_k];
  ...
  it('should validate numbers', function() {
    ...
    _ref2 = ['string', false, null, void 0];
    _results = [];
    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      value = _ref2[_k];
  ...
  it('should validate arrays', function() {
    ...
    _ref2 = ['string', false, 123, null, void 0];
    _results = [];
    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      value = _ref2[_k];
